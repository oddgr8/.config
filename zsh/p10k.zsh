# Generated by Powerlevel10k configuration wizard on 2025-07-24 at 14:07 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#f5c2e7'
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # Changed it to extend to 64 characters instead of 32
      (( $#branch > 64 )) && branch[25,-25]="…"
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#f9e2af'
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND='#f5e0dc'
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND='#f5e0dc'
